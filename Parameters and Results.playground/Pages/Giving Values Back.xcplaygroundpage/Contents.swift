 ...
 */
func makeFavorite (catogoryOfThings: String, favorite: String) -> String {
    return "my favorite \(catogoryOfThings) is \(favorite)"
}
let favoriteFood = makeFavorite(catogoryOfThings: "food", favorite: "cheese")
...
let favoriteMovie = makeFavorite(catogoryOfThings: "movie", favorite: "Ethernal sunshine of the spottles mind")
let favoriteBand = makeFavorite(catogoryOfThings: "band", favorite: "RHCP")
/*:
 ...
 */
print("Hello, my name is Sergey and \(favoriteFood), \(favoriteMovie) and \(favoriteBand).")
/*:
