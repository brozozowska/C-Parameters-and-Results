 ...
 */
func calculateCircumferense (diameter: Float) -> String {
    let pi: Float = 3.14
    let circumferense = pi * diameter
    return "Circumference of circle ⌀\(diameter) equal \(circumferense)"
}
calculateCircumferense(diameter: 20.6)
/*:
